...
public class StockPurchaseModel {
    ...
    public static ObservableList<StockPurchaseTM> getAllPurchases() throws ClassNotFoundException, SQLException {
     ...
     */
    public boolean saveStockPurchase(StockPurchaseDto purchaseDto, StockPurchaseItemsDto purchaseItemsDto) throws SQLException, ClassNotFoundException {
     ...
     */
    private boolean updateInventory(String inventoryItemID, double unitsReceived) throws SQLException, ClassNotFoundException {
        try {
    ...
    public boolean updateStockPurchase(StockPurchaseDto purchaseDto, StockPurchaseItemsDto purchaseItemsDto) throws SQLException, ClassNotFoundException {
        Connection connection = DBConnection.getInstance().getConnection();
        try {
            connection.setAutoCommit(false);
     ...
     */
    public String suggestNextPurchaseID() throws ClassNotFoundException, SQLException {
    ...
    public StockPurchaseTM searchPurchaseID(String purchaseID) throws SQLException, ClassNotFoundException {
        Connection connection = DBConnection.getInstance().getConnection();
